module Accredible
  class Credential
    ...
    def self.create(recipient:, credential:, evidence: [], references: [], group:)
      params = Util.build_create_credential_params(recipient, credential, evidence, references, group)
